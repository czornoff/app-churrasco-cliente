...
export default async function AdminTenantsPage() {
  // 1. Conexão e busca de dados (Server Side)
  await connectDB()
    ...
    <div className="max-w-4xl mx-auto space-y-10 p-4 md:p-8">
      ...
      <div className="flex items-center gap-3 border-b pb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Cadastre e gerencie os buffets que utilizam sua calculadora.</p>
        </div>
      </div>
      ...
      <Card className="border-2">
        <CardHeader>
          <CardTitle>Cadastrar Novo Buffet</CardTitle>
        </CardHeader>
        <CardContent>
