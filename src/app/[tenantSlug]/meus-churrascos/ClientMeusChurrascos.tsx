                ...
                <Table>
                    <TableHeader className="bg-zinc-100 dark:bg-zinc-800/50 border-y">
                        <TableRow className="border-none hover:bg-transparent">
                            ...
                            <TableHead className="px-6 py-3 text-center">Itens</TableHead>
                            <TableHead className="px-6 py-3 text-center">Total</TableHead>
                            <TableHead className="px-6 py-3 text-center">Ação</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {paginatedCalculations.map((calc) => (
                            <TableRow key={calc._id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-700/50 transition-colors">
                                <TableCell className="py-5 font-medium text-zinc-600 dark:text-zinc-400 text-sm px-6 py-3">
                                    <div className="flex items-center gap-2">
                                        <Calendar size={14} className="text-zinc-300" />
                                        {new Date(calc.createdAt).toLocaleDateString('pt-BR')}
                                    </div>
                                </TableCell>
                                <TableCell className="py-5 text-center px-6 py-3">
                                ...
                                <TableCell className="text-center font-black text-orange-600 px-6 py-3">
